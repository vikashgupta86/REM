      ...
      <div class="container">
        <div class="row align-items-center justify-content-center text-center">
          <div class="col-md-10">
            ...
            <h1 class="mb-2">Properties By Price Accending </h1>
      ...
      <div class="container">
         <div class="row">
          <div class="col-12">
            <div class="site-section-title mb-5">
              <h2>  Properties By Price Accending</h2>
        ...
        <div class="row mb-5">
          ...
          <div class="col-md-6 col-lg-4 mb-4">
              ...
              <div class="p-4 property-body">
                ...
                <ul class="property-specs-wrap mb-3 mb-lg-0">
                  <li>
                    ...
                    <span class="property-specs-number">{{ $relatedprop->beds??'Na' }} <sup>+</sup></span>
                    
                  </li>
                  <li>
                    <span class="property-specs">Baths</span>
                    <span class="property-specs-number">{{ $relatedprop->baths??'Na' }}</span>
                    
                  </li>
                  <li>
                    <span class="property-specs">SQ FT</span>
                    <span class="property-specs-number">{{ $relatedprop->sqft??'Na' }}</span>
            ...
            @else
            <div>
              <h3 class="text-center">No related properties found for this home type .</h3>
            </div>
            @endif
          {{-- <div class="col-md-6 col-lg-4 mb-4">
            <div class="property-entry h-100">
